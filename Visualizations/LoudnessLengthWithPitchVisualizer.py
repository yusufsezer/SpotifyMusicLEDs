...
class LoudnessLengthWithPitchVisualizer:
        ...
        for i in range(0, 12):
            ...
            for j in range(start, end + 1):
                ...
                faded_r, faded_g, faded_b = LoudnessLengthWithPitchVisualizer\
                    ._apply_gradient_fade(zone_r, zone_g, zone_b, color_strength, start_color)
    ...
    @staticmethod
    def _apply_gradient_fade(r, g, b, strength, start_color):
